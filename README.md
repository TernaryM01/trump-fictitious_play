"Trump" is a 4-player trick-taking card game which involves careful planning, bluffing, etc. This project builds a player AI to play the game skillfully using NFSP with DQN.
